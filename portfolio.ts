...
export const greetings: GreetingsType = {
  ...
  description:
    "Hello 👋 I am a Backend (Node.js) and Frontend (React.js) developer. I worked as a teacher at Sabina Academy for 3 months. I worked as a Full stack developer for LinCor campaign for 5 months. I have experience in DevOps and additional testing! ",
  resumeLink:
    '/Rezumi.pdf',
};
  ...
  data: [
    {
      ...
      skills: [
        ...
        emoji('⚡ Experience building fast, reliable, and secure jobs very quickly with Node.js and reliably submitting projects with supporting libraries'),
      ],
      softwareSkills: [
        {
          skillName: 'HTML-5',
